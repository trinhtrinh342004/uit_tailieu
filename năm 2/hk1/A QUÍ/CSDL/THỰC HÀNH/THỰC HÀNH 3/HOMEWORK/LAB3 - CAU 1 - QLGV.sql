...
GO
-- Cau 3:
ALTER TABLE HOCVIEN ADD CONSTRAINT CHECK_GIOITINH_HV CHECK (GIOITINH in ('Nam','Nu'))
ALTER TABLE GIAOVIEN ADD CONSTRAINT CHECK_GIOITINH_GV CHECK (GIOITINH in ('Nam','Nu'))
...
-- Cau 5:
ALTER TABLE KETQUATHI ADD CONSTRAINT CHECK_KQUA CHECK 
(
